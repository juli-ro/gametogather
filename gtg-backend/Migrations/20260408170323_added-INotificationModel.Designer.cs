...
namespace gtg_backend.Migrations
{
    ...
    [Migration("20260408170323_added-INotificationModel")]
    partial class addedINotificationModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("gtg_backend.Models.GroupSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("TelegramChatIdentification")
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("gtg_backend.Models.NotificationState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("gtg_backend.Models.GroupSettings", b =>
                {
                    b.HasOne("gtg_backend.Models.Group", "Group")
                        ...
                        .HasForeignKey("gtg_backend.Models.GroupSettings", "GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
