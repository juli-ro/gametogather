...
export class FeedbackService {
	...
	async openOkCancelDialog(title: string, message: string, confirmText = "ok", cancelText = "cancel"): Promise<boolean> {
	...
	async openInfoDialog(title: string, message: string, confirmText = "ok"): Promise<boolean> {
