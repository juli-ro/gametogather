...
@Component({
	...
	imports: [MatButton, MatCard, MatCardContent, MatCardHeader, MatFormField, MatInput, MatLabel, ReactiveFormsModule, MatIcon, MatMiniFabButton],
...
export class GameDetailComponent implements OnInit {
	...
	async deleteGame() {
		try {
			...
			if (gameToDelete) {
				const confirmed = await this.feedbackService.openOkCancelDialog(
					"Delete Game?",
