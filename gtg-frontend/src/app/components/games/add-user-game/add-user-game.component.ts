...
@Component({
	...
	imports: [FormsModule, MatFormFieldModule, MatInputModule, MatAutocompleteModule, ReactiveFormsModule, AsyncPipe, MatFabButton],
	templateUrl: "./add-user-game.component.html",
	styleUrl: "./add-user-game.component.scss",
	standalone: true,
})
export class AddUserGameComponent implements OnInit {
